...
public class VisaoDeGrafico implements VisaoSimulador
{
    ...
    private static JFrame frimport java.util.HashMap;
 ...
 * Classe que representa as estatísticas do campo na simulação,
 * incluindo o número de raposas e coelhos.
 */
public class EstatisticasCampo {
    // Número de raposas no campo.
    private int numeroDeRaposas;
    // Número de coelhos no campo.
    private int numeroDeCoelhos;

    /**
     * Construtor da classe EstatisticasCampo.
     * @param raposas O número inicial de raposas.
     * @param coelhos O número inicial de coelhos.
     */
    public EstatisticasCampo(int raposas, int coelhos) {
        this.numeroDeRaposas = raposas;
        this.numeroDeCoelhos = coelhos;
    }

    /**
     * Retorna o número de raposas.
     * @return O número de raposas.
     */
    public int getNumeroDeRaposas() {
        return numeroDeRaposas;
    }

    /**
     * Retorna o número de public interface VisaoSimulador {
